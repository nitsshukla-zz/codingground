...
Public Sub tc_adc_temp
 ...
 ' /////Check TEMP trim bit weights  //////////////
    ...
    Call setNoDrv("BCLK")
End Sub
Public Sub Wait(value As Long,unit As String)
End Sub
Public Function setDCAmps(PinName As String , Value As Double)  As Long
Return 0
End Function
'-------------------------------------------------------------
' Function :  measureLogic
'------------------------------------------------------------
Public Function measureLogic(PinName As String , Value As Long)  As Long
Return 0
End Function
'-------------------------------------------------------------
' Function :  measureDCAmps
'------------------------------------------------------------
Public Function measureDCAmps(PinName As String , Value As Double)  As Long
Return 0
End Function
'-------------------------------------------------------------
' Function :  measureDCVolts
'------------------------------------------------------------
Public Function measureDCVolts(PinName As String , Value As Double)  As Long
Return 0
End Function
'-------------------------------------------------------------
' Function :  setNoDrive
'------------------------------------------------------------
Public Function setNoDrive(PinName As String)  As Long
Return 0
End Function
'-------------------------------------------------------------
' Function :  testLimits
'------------------------------------------------------------
Public Function testLimits(TestNumber As Long , Value As Double , MinLimit As Double , MaxLimit As Double , Result As Long)  As Long
Return 0
End Function
'-------------------------------------------------------------
' Function :  setNoDrv
'------------------------------------------------------------
Public Function setNoDrv(PinName As String)  As Long
Return 0
End Function
'-------------------------------------------------------------
' Function :  setLogic
'------------------------------------------------------------
Public Function setLogic(PinName As String , Value As Long)  As Long
Return 0
End Function
'-------------------------------------------------------------
' Function :  setDCVolts
'------------------------------------------------------------
Public Function setDCVolts(PinName As String , Value As Double)  As Long
Return 0
End Function
'-------------------------------------------------------------
' Sub :  runPatternFlex
'------------------------------------------------------------
Public Sub runPatternFlex(PatFileName As String , TSetFileName As String , StartLabel As String , FailCyclesFileName As String , NumFailedCycles As Long , STCCmdFile As String , PrintLogMessage As Long)
End Sub
End Module
